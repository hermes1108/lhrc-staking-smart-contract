...
contract LiquidityPool is ERC20, Ownable, ReentrancyGuard {
    ...
    function addLiquidity(uint256 tTwoAmt) external payable nonReentrant{
        require(
            tokenTwo.allowance(msg.sender, address(this)) >= tTwoAmt,
    ...
    function swapOutCro() public payable nonReentrant{
    ...
    function swapOutToken(uint256 tokenAmtTwo) external nonReentrant{
